---
title: "Group Project"
author: "Kayle Ransby", "Shuzhen Heng", "Zhihao Song", "Hui Chen", "Giulio Dalla Riva"
date: "19/05/2021"
output: pdf_document
---
  ...
  for (baseComm in 1:reptimebase) {  
    ...
    for (nextComm in 1:reptimenext) {
      if (weeknum < totalweeks) {
          ...
          #Put the died community number in the father-son relationship,
          #if die_signal == reptimenext, which means every community from next week has zero intersection with this current community.
          if (nextComm == reptimenext & die_signal == reptimenext){
            new_row = c(weeknum, baseComm, 0, "s")     ## "s" stands for son_community_type
            community_trace[nrow(community_trace) + 1,] = new_row
         }
       }
     }
