...
We now know what communities continue to live and which ones die. However there is no way to know currently if a community has been born.
...
Save the predictors as a separate .csv file
...
svg("community_time_series.svg", width = 7.5, height = 6)
p
dev.off()
